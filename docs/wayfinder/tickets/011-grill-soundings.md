---
title: "Grill: Soundings and stateful instruments"
...
The descent state machine: rung chaining, 8-12 stop with convergence check, the consent gate UI (continue/park/another day), parked-sounding queue entries with depth kept, discomfort-as-coreness recording, and stateful instruments (five-slot episode probe, full triadic rep-grid) as scripts with slots.
