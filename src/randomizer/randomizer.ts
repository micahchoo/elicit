...
// Anniversary draw (ticket 107) — CUT with the zero-output sweeps (ruling
// 2026-08-09): the on-this-day offer died; the Randomizer's own channels
// (deck, resurfacing) are untouched.
