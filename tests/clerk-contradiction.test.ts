...
const POLE_A = 'keep my weekends completely free of work';
const POLE_B = 'worked through both days last weekend';
...
const CANDIDATE = { a: CLAIM_A, b: CLAIM_B, poleA: POLE_A, poleB: POLE_B };
...
describe('composeRemeasure', () => {
  ...
  it('rejects a spliced quote and accepts the same words set off', async () => {
    ...
    const neutral = { a: CLAIM_A, b: CLAIM_B, poleA: POLE_B, poleB: POLE_A };
